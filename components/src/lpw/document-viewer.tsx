  ...
  return (
    <AnnotationProvider>
      <div className="w-full max-w-7xl mx-auto my-6 px-3 sm:px-6 flex justify-center items-start gap-8 min-w-0">
        {/* 纸张主容器：限制最大宽度且溢出隐藏防越界 */}
        <div className="w-full max-w-4xl shrink-0 bg-surface-strong border border-line shadow-sm relative text-sea-ink font-sans overflow-hidden min-w-0">
          {/* 顶部识别元素 */}
            ...
            <header className="px-6 sm:px-10 pt-10 pb-8 bg-surface/40">
              ...
              <div className="flex flex-wrap justify-between items-center text-[11px] font-mono tracking-widest text-sea-ink-soft uppercase mb-5 gap-2">
                ...
                <div className="flex items-center gap-3">
                  <span className="text-lagoon font-bold">
                    KNOWLEDGE BLUEPRINT
                  </span>
