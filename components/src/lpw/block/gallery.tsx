...
const GalleryItem: React.FC<{ image: LpwGalleryImage; index: number }> = ({
  ...
  return (
    ...
    >
      <div className="border border-line bg-surface p-1 transition-colors group-hover:border-lagoon/50">
        <img
          src={resolvedSrc}
          alt={image.alt}
...
export const GalleryBlock: React.FC<LpwBlockSlotProps<LpwGalleryProps>> = ({
  ...
  return (
    <div
      ...
      className="grid grid-cols-[repeat(auto-fit,minmax(min(100%,14rem),1fr))] gap-5"
    >
