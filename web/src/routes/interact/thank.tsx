      ...
      >
        ...
        >
          ...
          <p className="mt-2 text-sm leading-relaxed text-sea-ink-soft">
            本次会话已归档，所有问答记录已保存。 请回到 AI Agent
            继续后续的开发工作。
          </p>
        </motion.div>
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-sm font-medium text-sea-ink">会话已结束</p>
        ...
        <motion.div className="mt-6 flex flex-col gap-2" variants={staggerItem}>
          <Button
            onClick={() => navigate({ to: '/interact', replace: true })}
