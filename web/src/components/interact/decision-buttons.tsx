  ...
  return (
    ...
    >
      <Button
        ...
        disabled={disabled}
        className={value === 'approve' ? activeCls.approve : idleCls.approve}
      >
      ...
      {variant === 'three' ? (
        <>
          <Button
            ...
            disabled={disabled}
            className={value === 'reject' ? activeCls.reject : idleCls.reject}
          >
        ...
        <Button
          ...
          disabled={disabled}
          className={value === 'revise' ? activeCls.revise : idleCls.revise}
        >
          <Pencil className="mr-1 size-3.5" aria-hidden />
          修改
        </Button>
