...
export type { QuestionComponentProps, SupplementRequestArgs } from './question-shell'
			...
			>
				{options.map((opt) => (
					<Label
						...
						className="flex cursor-pointer items-start gap-3 rounded-lg border border-line bg-foam px-3 py-2.5 transition-colors duration-150 has-[checked]:border-lagoon/30 has-[checked]:bg-lagoon/10 hover:border-lagoon/30"
					>
						<RadioGroupItem
							value={opt.id}
