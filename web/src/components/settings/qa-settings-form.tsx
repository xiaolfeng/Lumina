        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="qa.get-answer.poll-slice">
                  轮询间隔（毫秒）
                </Label>
                <Input
              ...
              <div className="space-y-2">
                <Label htmlFor="qa.get-answer.max-retries">
                  最大重试次数
                </Label>
                <Input
              ...
              <div className="space-y-2">
                <Label htmlFor="qa.max-active-sessions">
                  最大活跃会话数
                </Label>
                <Input
              ...
              <div className="flex items-center justify-between rounded-lg border p-4">
                <div className="space-y-0.5">
                  <Label htmlFor="qa.enable-file-upload" className="text-base">
                    启用文件上传
                  </Label>
