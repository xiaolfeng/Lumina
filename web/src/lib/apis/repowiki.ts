...
export function getRepoWikiConfig(
  id: string,
...
export function getRepoWikiVersionList(
  ...
  return apiClient.get(`/api/v1/repowiki/configs/${configId}/versions`, {
    params,
  })
}
...
export function updateSelectedVersion(
  ...
  return apiClient.put(
    `/api/v1/repowiki/configs/${configId}/selected-version`,
...
export function cleanFailedVersions(
  ...
  return apiClient.delete(
    `/api/v1/repowiki/configs/${configId}/versions/failed`,
  )
}
...
export function cleanRepoWikiGitCache(configId: string): Promise<BaseResponse> {
